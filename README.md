...
Works on Raspberry Pi 3, 4, 5 and Zero 2 W. Raspberry Pi OS based on Debian version 10 (Buster), version 11 (Bullseye) or version 12 (Bookworm) are the only compatible OS, as the project only works with Python version 3.7 to 3.11.
